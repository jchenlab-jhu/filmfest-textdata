...
setwd("D:/PNB/Work/College/Research/Chen_Lab/Description Consensus/theboyfriend")

#create additional directories
description_path <- "D:/PNB/Work/College/Research/Chen_Lab/Description Consensus/theboyfriend/descriptions/"
dir.create(description_path, showWarnings = FALSE)
figure_path <- "D:/PNB/Work/College/Research/Chen_Lab/Description Consensus/theboyfriend/figures/"
dir.create(figure_path, showWarnings = FALSE)
cosmat_path <- "D:/PNB/Work/College/Research/Chen_Lab/Description Consensus/theboyfriend/figures/cosmat/"
dir.create(cosmat_path, showWarnings = FALSE)
hist_path <- "D:/PNB/Work/College/Research/Chen_Lab/Description Consensus/theboyfriend/figures/hist/"
dir.create(hist_path, showWarnings = FALSE)
clean_path <- "D:/PNB/Work/College/Research/Chen_Lab/Description Consensus/theboyfriend/descriptions/clean/"
dir.create(clean_path, showWarnings = FALSE)
raw_path <- "D:/PNB/Work/College/Research/Chen_Lab/Description Consensus/theboyfriend/descriptions/raw/"
dir.create(raw_path, showWarnings = FALSE)

##load data
#contains trial data & keywords
trial.data <- read.csv("D:/PNB/Work/College/Research/Chen_Lab/Description Consensus/theboyfriend/trialdata.csv", header = FALSE, comment.char="#")
colnames(trial.data) <- c("ID","Trial","Timestamp","Datastring")
#contains post-task survey data
question.data <- read.csv("D:/PNB/Work/College/Research/Chen_Lab/Description Consensus/theboyfriend/questiondata.csv", header = FALSE, comment.char="#")
colnames(question.data) <- c("ID","Question","Response")
#contains window events (e.g., focus on/off, window resize, etc)
event.data <- read.csv("D:/PNB/Work/College/Research/Chen_Lab/Description Consensus/theboyfriend/eventdata.csv", header = FALSE, comment.char="#")
...
# #NOTE: for theboyfriend, don't run this section for now - TODO: COME BACK + uncomment
...
#CHECK: p good up until this point!

######################
###spoiler analysis###
######################

#CHECK: when we get new questions
...
practice_cAlls1 <- subset(description.data, description_stop == "1", select = c(description_content))
export_clean_description(practice_cAllsA, "practice", "All", "1")
...
test_cAllsegTitle <- description.data[grep("filmfest_clip12_title_7s.mp4", description.data$vidpath), ]
test_cAllsegTitle <- subset(test_cAllsegTitle, select = c(description_content))
export_clean_description(test_cAllsegTitle, "test", "All", "Title")

#counterbalance: 0
test_c0s1 <- subset(description.data, counterbalance == 0 & description_stop == "1", select = c(description_content))
...
#counterbalance: 1
test_c1s1 <- subset(description.data, counterbalance == 1 & description_stop == "1", select = c(description_content))
...
#counterbalance: 2
test_c2s1 <- subset(description.data, counterbalance == 2 & description_stop == "1", select = c(description_content))
...
#counterbalance: 3
test_c3s1 <- subset(description.data, counterbalance == 3 & description_stop == "1", select = c(description_content))
...
#counterbalance: 4
test_c4s1 <- subset(description.data, counterbalance == 4 & description_stop == "1", select = c(description_content))
...
#counterbalance: 5
test_c5s1 <- subset(description.data, counterbalance == 5 & description_stop == "1", select = c(description_content))
...
#counterbalance: 6
test_c6s1 <- subset(description.data, counterbalance == 6 & description_stop == "1", select = c(description_content))
...
#counterbalance: 7
test_c7s1 <- subset(description.data, counterbalance == 7 & description_stop == "1", select = c(description_content))
...
#counterbalance: 8
test_c8s1 <- subset(description.data, counterbalance == 8 & description_stop == "1", select = c(description_content))
