...
trial.data <- read.csv("D:/PNB/Work/College/Research/Chen_Lab/Description Consensus/busstop/trialdata.csv", header = FALSE, comment.char="#")
...
question.data <- read.csv("D:/PNB/Work/College/Research/Chen_Lab/Description Consensus/busstop/questiondata.csv", header = FALSE, comment.char="#")
...
event.data <- read.csv("D:/PNB/Work/College/Research/Chen_Lab/Description Consensus/busstop/eventdata.csv", header = FALSE, comment.char="#")
...
# #NOTE: for busstop, don't run this section for now - TODO: COME BACK + uncomment
...
#TODO: update, hitID currenlty not found
...
#calculate number of ppredictions per stop
#UPDATE FOR DESCRIPTION
...
#calculate SD across description per stop
#NOTE: does description consensus have multiple descriptions for 1 stop...? Does it matter
#UPDATE FOR DESCRIPTION
