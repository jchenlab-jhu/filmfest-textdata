...
setwd("D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Merged/busstop")


prediction_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Merged/busstop/final/predictions/"
dir.create(prediction_path, showWarnings = FALSE)
figure_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Merged/busstop/final/figures/"
dir.create(figure_path, showWarnings = FALSE)
cosmat_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Merged/busstop/final/figures/cosmat/"
dir.create(cosmat_path, showWarnings = FALSE)
hist_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Merged/busstop/final/figures/hist/"
dir.create(hist_path, showWarnings = FALSE)

clean_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Merged/busstop/final/predictions/clean/"
dir.create(clean_path, showWarnings = FALSE)
raw_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Merged/busstop/final/predictions/raw/"
dir.create(raw_path, showWarnings = FALSE)

#create additional directories
new_busstop_data <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/New_2021/busstop/final/predictions/clean/"
dir.create(new_busstop_data, showWarnings = FALSE)
new_txtfiles_list <- list.files(new_busstop_data)
old_busstop_data <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/busstop/predictions/clean/"
dir.create(old_busstop_data, showWarnings = FALSE)
old_txtfiles_list <- list.files(new_busstop_data)
...
for (i in 1:length(old_txtfiles_list)){
  temp_old_data <- read.table(paste(old_busstop_data, old_txtfiles_list[i], sep =""), sep = "\t", header = FALSE, quote = "")
  temp_new_data <- read.table(paste(new_busstop_data, old_txtfiles_list[i], sep =""), sep = "\t", header = FALSE, quote = "") 
  temp_merged_data <- rbind(temp_old_data,temp_new_data)
  
  #not entirely sure what these two lines do (copied from export clean prediction function)- ask Buddhika
...
#merge data frames
setwd("D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/busstop") #set wd to directory of old data
old_df <- readRDS(file = "old_data.Rds")

setwd("D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/New_2021/busstop/final") #set wd to directory of new data
...
export_raw_prediction <- function(df, phase){
  write.csv(df, file = paste0(raw_path,"busstop_merged",phase,"_full.csv")) #save full dataframe to csv
}
