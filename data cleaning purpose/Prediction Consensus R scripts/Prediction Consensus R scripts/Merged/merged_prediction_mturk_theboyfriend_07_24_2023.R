...
setwd("D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Merged/theboyfriend")


prediction_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Merged/theboyfriend/predictions/"
dir.create(prediction_path, showWarnings = FALSE)
figure_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Merged/theboyfriend/figures/"
dir.create(figure_path, showWarnings = FALSE)
cosmat_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Merged/theboyfriend/figures/cosmat/"
dir.create(cosmat_path, showWarnings = FALSE)
hist_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Merged/theboyfriend/figures/hist/"
dir.create(hist_path, showWarnings = FALSE)

clean_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Merged/theboyfriend/predictions/clean/"
dir.create(clean_path, showWarnings = FALSE)
raw_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Merged/theboyfriend/predictions/raw/"
dir.create(raw_path, showWarnings = FALSE)

#create additional directories
new_theboyfriend_data <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/New_2021/theboyfriend/predictions/clean/"
dir.create(new_theboyfriend_data, showWarnings = FALSE)
new_txtfiles_list <- list.files(new_theboyfriend_data)
old_theboyfriend_data <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/theboyfriend/predictions/clean/"
dir.create(old_theboyfriend_data, showWarnings = FALSE)
old_txtfiles_list <- list.files(new_theboyfriend_data)
...
for (i in 1:length(old_txtfiles_list)){
  temp_old_data <- read.table(paste(old_theboyfriend_data, old_txtfiles_list[i], sep =""), sep = "\t", header = FALSE, quote = "")
  temp_new_data <- read.table(paste(new_theboyfriend_data, old_txtfiles_list[i], sep =""), sep = "\t", header = FALSE, quote = "") 
...
#merge data frames
setwd("D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/theboyfriend") #set wd to directory of old data
old_df <- readRDS(file = "old_data.Rds")

setwd("D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/New_2021/theboyfriend") #set wd to directory of new data
...
export_raw_prediction <- function(df, phase){
  write.csv(df, file = paste0(raw_path,"theboyfriend_merged_",phase,"_full.csv")) #save full dataframe to csv
}
