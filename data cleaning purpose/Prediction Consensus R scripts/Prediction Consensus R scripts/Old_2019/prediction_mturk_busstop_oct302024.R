...
setwd("D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/busstop/")

#create additional directories
prediction_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/busstop/predictions/"
dir.create(prediction_path, showWarnings = FALSE)
figure_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/busstop/figures/"
dir.create(figure_path, showWarnings = FALSE)
cosmat_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/busstop/figures/cosmat/"
dir.create(cosmat_path, showWarnings = FALSE)
hist_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/busstop/figures/hist/"
dir.create(hist_path, showWarnings = FALSE)
clean_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/busstop/predictions/clean/"
dir.create(clean_path, showWarnings = FALSE)
raw_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/busstop/predictions/raw/"
dir.create(raw_path, showWarnings = FALSE)

##load data
#contains trial data & keywords
trial.data <- read.csv("D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/busstop/trialdata.csv", header = FALSE, comment.char="#")
colnames(trial.data) <- c("ID","Trial","Timestamp","Datastring")
#contains post-task survey data
question.data <- read.csv("D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/busstop/questiondata.csv", header = FALSE, comment.char="#")
colnames(question.data) <- c("ID","Question","Response")
#contains window events (e.g., focus on/off, window resize, etc)
event.data <- read.csv("D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/busstop/eventdata.csv", header = FALSE, comment.char="#")
...
export_raw_prediction <- function(df, phase){
  write.csv(df, file = paste0(raw_path,"busstop_",phase,"_full.csv")) #save full data frame to csv
}
...
#path to python script: /Users/bbellan1/Dropbox/Academic/Projects/JHU/online_experiments/D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/busstop/predictions
...
ggplot(data=use.data, aes(x=offset, y=similarity)) +
  ...
  xlab("time (s)") + ylab("cosine similarity") + ylim(-0.1, .8)
...
setwd("D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/busstop/roi_tc/tc")
temp = list.files(pattern="*.txt")
tc_list = lapply(temp, function(x) read.delim(x, header = FALSE, sep = ","))
#load group averaged pISC ROI timecourses
setwd("D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/busstop/roi_tc/pisc")
...
for (i in 1:length(tc_list)){
  ...
  #set path
  setwd("D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/busstop/roi_tc/")
