...
setwd("D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/cmiyc_long/")

#create additional directories
prediction_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/cmiyc_long/predictions/"
dir.create(prediction_path, showWarnings = FALSE)
figure_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/cmiyc_long/figures/"
dir.create(figure_path, showWarnings = FALSE)
cosmat_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/cmiyc_long/figures/cosmat/"
dir.create(cosmat_path, showWarnings = FALSE)
hist_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/cmiyc_long/figures/hist/"
dir.create(hist_path, showWarnings = FALSE)
clean_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/cmiyc_long/predictions/clean/"
dir.create(clean_path, showWarnings = FALSE)
raw_path <- "D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/cmiyc_long/predictions/raw/"
dir.create(raw_path, showWarnings = FALSE)

##load data
#contains trial data & keywords
trial.data <- read.csv("D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/cmiyc_long/trialdata.csv", header = FALSE, comment.char="#")
colnames(trial.data) <- c("ID","Trial","Timestamp","Datastring")
#contains post-task survey data
question.data <- read.csv("D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/cmiyc_long/questiondata.csv", header = FALSE, comment.char="#")
colnames(question.data) <- c("ID","Question","Response")
#contains window events (e.g., focus on/off, window resize, etc)
event.data <- read.csv("D:/PNB/Work/College/Research/Chen_Lab/Prediction Consensus Data/Old_2019/cmiyc_long/eventdata.csv", header = FALSE, comment.char="#")
...
#select participants from April 19, 2019 pilot (different version of exp, mainly just missing the quiz about spoilers -- still useable)
drop.pilots <- c("A23FMTVKQEYCMW:3IRIK4HM3BWAA2LRCR7WZ2K76JS6CC",
                 "A1GXFMAC759VRM:3G5W44VEU8UUQTMLGHXGZCA4563KG4",
                 "A1QRGVE005067Q:31UV0MXWNRO5417DZITDIZ42NT05IW",
                 "debugYAJQGU:debugLVSLMT",
                 "A1SHLWKA0UH1IS:3OJSZ2ATDT88FHQHGRPGRAET9DQ754",
                 "A3O5EU9QQV2OS1:3VBEN272MLBSECZTLQ6IQY1EM0GSGT",
                 "A250FES5PFCGK9:3IRIK4HM3BWAA2LRCR7WZ2K76JS6CC",
                 "AH31QLJ57XC8W:3G5W44VEU8UUQTMLGHXGZCA4563KG4",
                 "A125KW9P18V5Z1:3XUHV3NRVLA586WTT0BSIN3NNGL5H3",
                 "A20N1NK5X5S88F:3EFE17QCRDH6E8U45WO0BYDF10TSHS",
                 "AWY6W20U8H3JA:3IRIK4HM3BWAA2LRCR7WZ2K76JS6CC",
                 "A3J85WP15JFYW0:3CFJTT4SXU2KR5LWNB8AGJIYEZWI7P",
                 "A2ML0070M8FDK1:3EFE17QCRDH6E8U45WO0BYDF10TSHS",
                 "ADAQIHMKC6NVC:3H7XDTSHKD3LLTG25VGJNN4ZSDEGWY",
                 "A2Z43TA0WZ0EG0:3CFJTT4SXU2KR5LWNB8AGJIYEZWI7P",
                 "A2ALS5JL34DXTG:31QNSG6A5S5R2Z9JEPWJ3UOKB3W78B",
                 "AYQAO6B91191T:3NGMS9VZTMUDW7YC4M011EINWVMFFY",
                 "A196XR61DIW5GU:3EFE17QCRDH6E8U45WO0BYDF10TSHS",
                 "A2IVGLOBFOT67M:37M28K1J0RPY5I30CW5U2BZOSM0JA2",
                 "A1Q5RFVJKMZBEN:31QNSG6A5S5R2Z9JEPWJ3UOKB3W78B",
                 "A30NWLRPW1XUSH:3OONKJ5DKDVHP3ZPYNXV5I0G9Y0OBQ",
                 "debugDJUGW6:debug0E7QEA",
                 "A2EOOF9D135HQ1:39OWYR0EPL3JWYF79CSPQZP32BDYFP",
                 "A1YZJTC04W0A01:37WLF8U1WQ2ST0XF44OUNLXFBXCK6O",
                 "AEKJ0Q3OITMRJ:3GGAI1SQEWACZ56JZ7EDOYHTWOICMD",
                 "AC6Y70F8YSHJN:3QY7M81QH8YBX0BKNETMTZXB68WK7N",
                 "A3OGH0HZMJPS9W:30BXRYBRP59ZLPBDP1Y18NG07I1HWI",
                 "A1GV0UZU0T2ORS:3X31TUMD7YY86KE0JYOE7PJDSM1L1U",
                 "A2FL477TMKC91L:3S0TNUHWKUU7J8AT52Z53MYGXJ68DM",
                 "AZ5ZYUCAQ0XDL:34V1S5K3GTD8C4EO07X5XCJZ03196K",
                 "A2TLN8489YGY81:3VW04L3ZLUIBWFGI4AC9DSI14ASXXM",
                 "debugOGHQCW:debug6SUAKB",
                 "A2P53AN2M8IWFP:3LPW2N6LKUEADS2DTZIR12SDHZR5UU")
...
#rename columns
colnames(temp4) <- c("confidence", "time", "prediction_number", "vidpath", "prediction_content", "tag", "counterbalance", "offset", "phase", "scratch", "Confidence", "video_segment", "ID", "Trial")
temp <- temp4
